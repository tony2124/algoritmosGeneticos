 ...
 *
 *
 * @author Alfonso CalderÃ³n ChÃ¡vez
 * @version 1.00 2012/6/29
 */
import java.text.DecimalFormat;
import java.util.Scanner;

public class MinimizacionElitismo{

    public MinimizacionElitismo() {
    }
    ...
    public static void main (String[] args) 
    {
        ...
        do
        {
    	//DecodificaciÃ³n y calculo de la aptitup relativa
    	...
    	for(int i = 0; i < numeroIndividuos; i++)
    	{
    		...
    		tablaDecodificacion[i] = Double.parseDouble(digitos.format(evaluarFuncion(x,y)));
                if(tablaDecodificacion[i] < min )
                {
                    ...
                    System.out.println("El mejor individuo es: "+ind+"   ----   "+min);
    	...
    	//cÃ¡lculo de aptitud relativa y acumulativa
    //	System.out.println("\nValores normalizados y aptitud acumulada:\n");
    	...
    	//Aplicando el mÃ©todo de la ruleta para la SELECCION
    //	System.out.println("\nAplicando el mÃ©todo de la ruleta para selecciÃ³n\n");
    	...
    	for(int i = 0; i < numeroIndividuos; i++)
    	{
    		...
    		//System.out.println("\nNÃºmero generado: "+numeroAleatorio+"\n");
    ...
    //	System.out.println("\nSeleccionando individuos para la cruza\n");
    	...
    	for(int i = 0, j = 0; i < cont / 2; i++, j+=2)
    	{
    		num = (int) ((Math.random()*1000) % tamIndividuo);
              ...
              /*  
    		System.out.println("\nNumero de donde se cortarÃ¡ la cadena: "+num);
