...
public class MaximizacionReal {
    ...
    public static void main (String[] args) 
    {
    	...
    	{
            individuos[i][0] = generarReal(lsupx, linfx);
            individuos[i][1] = generarReal(lsupy, linfy);
    	}
    	...
    	for(int i = 0; i < numeroIndividuos; i++)
    	{
    		...
    		tablaDecodificacion[i] = Double.parseDouble(digitos.format(evaluarFuncion(x,y)));
                if(tablaDecodificacion[i] > max )
                {
                    ...
                    System.out.println("El mejor individuo es: "+ind+"      "+x+"   "+y+"    ----   "+max);
